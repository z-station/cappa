...
from cappa.training.models import Topic, Content
from cappa.training.admin import TaskItemInline
from cappa.training.forms import TopicAdminForm, ContentAdminForm
